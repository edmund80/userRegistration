...
SECRET_KEY = "django-insecure-%occ7=4kutg)7^p%a$b$to=)iui+_6n=9gkid)#)-y+(9b=436"
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'genetestemail4@gmail.com'
EMAIL_HOST_PASSWORD = 'tyzg aslr ogbr nmdq'
